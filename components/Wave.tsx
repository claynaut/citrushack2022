...
export const Wave = ({ type, bgColor, fillColor }: Props) => (
  <div className={'w-full bg-' + bgColor}>
      {
        type === 1 &&
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 119 1440 200' className='w-full'>
          <path 
            fill={'var(--' + fillColor + ')'} 
            fillOpacity='1' 
      ...
      {
        type === 2 &&
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 19 1440 300' className='w-full'>
          <path 
            fill={'var(--' + fillColor + ')'} 
            fillOpacity='1' 
      ...
      {
        type === 3 &&
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 59 1440 260' className='w-full'>
          <path 
            fill={'var(--' + fillColor + ')'} 
            fillOpacity='1' 
      ...
      {
        type === 4 &&
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 179 1440 140' className='w-full'>
          <path 
            fill={'var(--' + fillColor + ')'} 
            fillOpacity='1' 
